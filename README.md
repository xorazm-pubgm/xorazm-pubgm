...
# 🎖 XORAZM-PUBGM | OFFICIAL PROFILE
### "Skill is defined by performance, not by FPS."

<img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=FFBC00&center=true&vCenter=true&width=500&lines=Winner+Winner+Chicken+Dinner!;45+FPS+Professional+Player;Xorazm+Guch+Team+Leader;Global+ID:+51484051001" alt="Typing SVG" />
...
| 👤 **In-Game Name** | `Xorazm-GUCH` |
| 🛡 **Current Rank** | `Ace Dominator` |
| ⚔️ **Role** | `IGL / Main Rusher` |

---

## 🔫 Combat Arsenal (Favorite Loadout)
* **Primary:** M416 + 6x (Spray Master) 🎯
* **Secondary:** UMP45 / AKM (Close Range) 🔥
* **Sniper:** AWM / M24 (One Shot, One Kill) 💀
* **Favorite Map:** Erangel & Livik 🗺

---

## ⚙️ Technical Specs
* **Frame Rate:** ⚡ 45 FPS Stable
* **Controls:** 4-Finger Claw + Full Gyroscope 🎯
* **Sensitivity:** Custom Pro Config
